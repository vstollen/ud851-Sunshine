...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_tv_weatherDisplay = (TextView) findViewById(R.id.tv_weather_data);
        ...
        for (String fakeWeatherDate : fakeWeatherData) {
            m_tv_weatherDisplay.append(fakeWeatherDate + "\n\n");
        }
    }
}